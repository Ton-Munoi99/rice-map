...
- **คำนวณ (เกณฑ์):**
  ...
  ตัวอย่างเกณฑ์ 🟡 เดือน ก.ย.: แม่ฮ่องสอน 220 มม. · นครราชสีมา 119 มม. · นครศรีธรรมราช 93 มม.
  · ค่าปกติสรุปข้ามจุดตัวอย่าง ≤6 จุด/จังหวัด ด้วย p90 วิธีเดียวกับฝั่งพยากรณ์ (ถ้าใช้ centroid จุดเดียว
  จะเป็นการเทียบ p90 กับค่าจุดเดียว เอนไปทางเตือนเกินราว 1.28 เท่า และไม่เท่ากันทุกจังหวัด 0.97-2.16 เท่า)
