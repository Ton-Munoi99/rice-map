...
MIN_EVI_MAX   = 0.22   # ต้องเคย "โล่ง/น้ำขัง" อย่างน้อย 1 เดือน (min EVI ต่ำ) → ตัวตัดยาง/ปาล์ม/ป่า
                       # 0.20 เข้มเกินไป — นาไทยหลายที่มีวัชพืช/ตอซังคลุม ไม่เคยโล่งขนาดนั้น
                       # จึงถูกตัดทิ้ง วัดจริง 61 จังหวัดที่เว็บแสดง: 0.20 นับได้ 45% ของ OAE
                       # คลาดกลาง 59% · 0.22 นับได้ 70% คลาดกลาง 42% คลาดเฉลี่ย 58%→50%
