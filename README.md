...
- 📊 **21 Data Layers** — ผลผลิต/ผลผลิตต่อไร่/เนื้อที่/ราคา/กำไร, ฝน+พยากรณ์ (รวม TMD 48 ชม.),
  ความชื้นดิน, สภาพนาข้าว (EVI), เขื่อน, ระดับน้ำ, เตือนน้ำท่วม, **น้ำท่วมจริงจากดาวเทียม GISTDA**,
...
- 🤖 **อัปเดตอัตโนมัติ** — GitHub Actions cron 20 workflow ดึงข้อมูลสดรายวัน/รายสัปดาห์
