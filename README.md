...
- 📊 **20 Data Layers** (แสดงปุ่ม 18) — ผลผลิต/ผลผลิตต่อไร่/เนื้อที่/ราคา/กำไร, ฝน+พยากรณ์,
  เขื่อน, ระดับน้ำ, สถานีฝน, เตือนน้ำท่วม, **น้ำท่วมวัดจริงจากสถานีวัดน้ำ**,
  โรงสี, โรงไฟฟ้าชีวมวล, ฟางข้าว · ความชื้นดินกับสภาพนาข้าว (EVI) ยังมีข้อมูลและการ์ด
  ในหน้ารายละเอียดจังหวัด เพียงแต่ไม่มีปุ่มในรายการชั้นข้อมูล
...
- 🤖 **อัปเดตอัตโนมัติ** — GitHub Actions cron 18 workflow ดึงข้อมูลสดรายวัน/รายสัปดาห์
